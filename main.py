...
#calendario
    def mostrar_el_calendario(self):
        ...
        Button(calendario, text="Seleccione la fecha", font=("Rockwell", 9, "bold",),bg="royalblue",command=selecionar_fecha).grid()
        
        calendario.mainloop()

#parte de los widgets
    def widgets(self):
        ...
        Label(self.frame_uno, text="Opciones", bg="deepskyblue", fg="black", font=("Rockwell", 13, "bold",)).grid(
            column=2, row=0)
        ...
        Label(self.frame_uno, text="REGISTRO DE PACIENTES", fg="black", bg="deepskyblue",
              font=("Rockwell", 23, "bold",)).grid(columnspan=3, column=0, row=0, pady=5)
        ...
        Entry(self.frame_uno, textvariable=self.Nombre, font=("Rockwell", 13, "bold") , highlightbackground="blue", bg="white", highlightthickness=5).grid(column=1, row=1)
        Entry(self.frame_uno, textvariable=self.Asunto, font=("Rockwell", 13, "bold"), highlightbackground="blue", bg="white", highlightthickness=5).grid(column=1, row=2)
        Entry(self.frame_uno, textvariable=self.Correo, font=("Rockwell", 13, "bold"), highlightbackground="blue", bg="white", highlightthickness=5).grid(column=1, row=3)
        Entry(self.frame_uno, textvariable=self.Telefono, font=("Rockwell", 13, "bold"), highlightbackground="blue", bg="white", highlightthickness=5).grid(column=1, row=4)
        Entry(self.frame_uno, textvariable=self.Fecha, font=("Rockwell", 13, "bold"), highlightbackground="blue", bg="white", highlightthickness=5).grid(column=1, row=5)
        Label(self.frame_uno, text="-Doble click para eliminar el usurario-", fg="black", bg="deepskyblue", font=("Rockwell", 13, "bold",)).grid(column=1,row=6, pady=5)
        ...
        Button(self.frame_uno, text='LIMIPIAR DATOS', font=('Arial', 9, 'bold'), bg='limegreen',
